...
$query_Recordset1 = "SELECT * FROM teacher";
            ...
            <tr>
              <td height="169"><table width="700" border="1">
                ...
                <?php do { ?>
                  <tr align="center">
                    <td width="100">姓名</td>
                    <td width="100"><?php echo $row_Recordset1['name']; ?></td>
                    <td width="100">性别</td>
                    <td width="100"><?php echo $row_Recordset1['sex']; ?></td>
                  </tr>
                  <tr align="center">
                    <td>生日</td>
                    <td colspan="3"><?php echo $row_Recordset1['year']; ?>年<?php echo $row_Recordset1['month']; ?>月<?php echo $row_Recordset1['day']; ?>日</td>
                  ...
                  <tr align="center">
                    ...
                    <td colspan="3"> 
                      <?php 
	$var = $row_Recordset1['name'];
	$sql = mysql_query("select * from teachersl where tname='".$var."'",$webconn);
